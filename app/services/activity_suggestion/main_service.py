...
from app.api.schemas.activity_suggestion import ActivitySuggestionRequest, ActivitySuggestionResponse, Activity, \
    DailyRoutine, JournalPrompt
...
async def generate_activity_routine(data: ActivitySuggestionRequest, db: AsyncSession = Depends(get_db)) -> ActivitySuggestionResponse:
    ...
    return ActivitySuggestionResponse(routine=daily_routine)
